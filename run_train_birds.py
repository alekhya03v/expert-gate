import torch
from config import BIRDS_IMDB, IMAGENET_MEAN, IMAGENET_STD, INPUT_SIZE, CODE_SIZE, BATCH_SIZE, NUM_EPOCHS, LEARNING_RATE, WEIGHT_DECAY, BIRDS_EXP
...
def main():
    ...
    dataset = build_dataset(BIRDS_IMDB, IMAGENET_MEAN, IMAGENET_STD, apply_sigmoid=True)
